...
const InnovationCard = ({ icon, title, description, badge, bgImage, gradient }: CardProps) => {
  return (
    <div className={`bg-[url('${bgImage}')] bg-cover bg-center rounded-2xl hover:border hover:border-[#A3E635]`}>
      <div className={`w-[600px] pb-3 rounded-2xl`} style={{ background: gradient }}>
        <div className="flex justify-between items-center py-3 px-5">
          {icon}
          <p className="flex items-center text-[#A3E635] text-sm bg-[#0F172ACC] rounded-2xl h-5 px-3.5 text-center">
            {badge}
          </p>
        </div>
        <p className="font-bold text-white text-2xl px-5 mt-2 hover:text-[#A3E635]">{title}</p>
        <p className="text-[#9CA3AF] text-base mt-30 font-medium px-5">{description}</p>
      </div>
    </div>
  );
};
...
function Innovation() {
  const cards: CardProps[] = [
    {
      icon: <Brain className="bg-[#A3E635] w-12 h-12 p-3 rounded-2xl" />,
      ...
      bgImage: './assets/AI.jpg',
      gradient: 'linear-gradient(135deg,#0F172AAA 0%,#1E293BAA 50%,#0F172A 100%)',
    },
    {
      icon: <Leaf className="bg-[#A3E635] w-12 h-12 p-3 rounded-2xl" />,
      ...
      badge: '60% less CO2',
      bgImage: './assets/eco-smart.jpg',
      gradient: 'linear-gradient(135deg,#0F172AAA 0%,#1E293BAA 50%,#0F172A 100%)',
    },
    {
      icon: <ShieldCheck className="bg-[#A3E635] w-12 h-12 p-3 rounded-2xl" />,
    ...
    {
      icon: <Wifi className="bg-[#A3E635] w-12 h-12 p-3 rounded-2xl" />,
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#0F172A] py-5">
      <h1 className="text-white font-bold text-6xl py-5">
        Cutting - Edge <span className="text-[#A3E635]">Innovations</span>
      </h1>
